...
export const INITIAL_PROJECTS: Project[] = [
  {
    ...
    actions: [
      { id: 'a1', title: 'Contrat prestataire son', assignee: 'Paul Adjé', due: '2026-07-10', status: 'en_cours' },
      { id: 'a2', title: 'Visuels réseaux sociaux', assignee: 'Jean Kouassi', due: '2026-07-05', status: 'a_faire' },
      { id: 'a3', title: 'Liste des orateurs', assignee: 'Esther Bamba', due: '2026-06-20', status: 'fait' },
      { id: 'a4', title: 'Plan de salle & protocole', assignee: 'Paul Adjé', status: 'a_faire' },
    ],
  },
  { id: 'proj_rsa', name: 'RSA', scope: 'transverse', status: 'En cours', pmo: 'Non assigné' },
  { id: 'proj_game_changers', name: 'Game Changers', scope: 'transverse', status: 'En cours', pmo: 'Non assigné' },
  { id: 'proj_finances', name: 'Les Finances', scope: 'transverse', status: 'En cours', pmo: 'Non assigné' },
  { id: 'proj_inside', name: 'Inside (ex RDV Spécial)', scope: 'branche', branch: 'light', status: 'En cours', pmo: 'Non assigné' },
  { id: 'proj_after', name: 'Le After', scope: 'branche', branch: 'church', status: 'En cours', pmo: 'Non assigné' },
];
...
export const INITIAL_DEPARTMENTS: Department[] = [
  ...
  { id: 'dept_dancers', name: 'Bloom Dancers', type: 'normal', ministryId: 'min_art', description: '' },
  { id: 'dept_cinema', name: 'Bloom Cinema', type: 'normal', ministryId: 'min_art', description: '' },
  { id: 'dept_trap_church', name: 'Trap Church', type: 'normal', ministryId: 'min_art', description: '' },
  { id: 'dept_bloom_art', name: 'Bloom Art', type: 'normal', ministryId: 'min_art', description: '' },

  // 3. Ministère de la Tech & Scène
  { id: 'dept_tech', name: 'Prod & Tech', type: 'normal', ministryId: 'min_tech_scene', description: '' },
  { id: 'dept_decoration', name: 'Décoration', type: 'normal', ministryId: 'min_tech_scene', description: '' },
  { id: 'dept_traduction', name: 'Traduction', type: 'normal', ministryId: 'min_tech_scene', description: '' },
  { id: 'dept_dirigeants', name: 'Dirigeants', type: 'normal', ministryId: 'min_tech_scene', description: '' },

  // 4. Ministère de la Rétention
  { id: 'dept_resho_bloom', name: 'Resho Bloom', type: 'normal', ministryId: 'min_retention', description: '' },
  { id: 'dept_adn', name: 'ADN', type: 'special', specialFunction: 'adn', ministryId: 'min_retention', description: 'Accueil des nouveaux' },
  { id: 'dept_social', name: 'Social', type: 'normal', ministryId: 'min_retention', description: '' },
  { id: 'dept_integration', name: 'Intégration', type: 'special', specialFunction: 'integration', ministryId: 'min_retention', description: 'Suivi des nouveaux' },
  { id: 'dept_oj', name: 'OJ', type: 'normal', ministryId: 'min_retention', description: '' },
  ...
  { id: 'dept_ushers', name: 'Ushers', type: 'special', specialFunction: 'portiers', ministryId: 'min_coordination', description: 'Placement et comptage' },
  { id: 'dept_gdc', name: 'GDC', type: 'special', specialFunction: 'gestion_cultes', ministryId: 'min_coordination', description: 'Gestion des cultes' },
  { id: 'dept_protocole', name: 'Protocole', type: 'normal', ministryId: 'min_coordination', description: '' },
  { id: 'dept_dress_code', name: 'Dress Code', type: 'normal', ministryId: 'min_coordination', description: '' },

  // 7. Ministère de l'Affermissement
  { id: 'dept_eden_zero', name: 'Eden Zero', type: 'special', specialFunction: 'parcours_etapes', ministryId: 'min_affermissement', description: 'Parcours étapes' },
  { id: 'dept_academie', name: 'Académie', type: 'normal', ministryId: 'min_affermissement', description: '' },
...
export const TEST_PROFILES: Member[] = [
  ...
  testProfile(3, 'Pasteur Principal', 'PasteurPrincipal', { pastoralCursus: 'pasteur_titulaire' }),
  testProfile(4, 'Pasteur', 'Pasteur', { pastoralCursus: 'pasteur_assistant' }),
  ...
  testProfile(10, 'Capitaine de Bus', 'Capitaine', { departments: { dept_bloom_bus: 'capitaine' }, bloomBusId: 'bus_yop_maroc' }),
  testProfile(11, 'Responsable de Zone', 'Zone', { departments: { dept_bloom_bus: 'responsable_zone' }, bloomBusId: 'bus_coc_angre' }),
  testProfile(12, 'Responsable de Commune', 'Commune', { departments: { dept_bloom_bus: 'responsable_commune' }, bloomBusId: 'bus_coc_angre' }),
...
export const INITIAL_MEMBERS: Member[] = [
  {
    ...
    departments: { 'dept_bloom_bus': 'responsable_zone', 'dept_integration': 'responsable' },
  ...
  },
  {
    ...
    branch: 'church',
    level: 'coach',
    pastoralCursus: 'pasteur_assistant',
  ...
  },
  {
    ...
    branch: 'light',
    level: 'coach',
    pastoralCursus: 'pasteur_titulaire',
  ...
  // Active Boss and Leaders for list richness
  {
    ...
    level: 'boss',
    pastoralCursus: 'aucun',
    departments: { 'dept_bloom_bus': 'capitaine' },
    bloomBusId: 'bus_yop_maroc',
...
export const VIEW_PERMISSIONS: PermissionMatrix = {
  ...
  'view_pole': allow('Responsable de section'),
