...
export const DepartmentSchema = z.object({
  ...
  ministryId: z.string(),
  description: z.string(),
  specialFunction: z.enum(['adn', 'portiers', 'integration', 'bloom_bus', 'gestion_cultes', 'parcours_etapes', 'bapteme']).optional(),
  branch: branch.optional(),
...
export const ProjectSchema = z.object({
  ...
  team: z.array(z.object({ member: z.string(), memberId: z.string().optional(), role: z.string() }).strict()).optional(),
